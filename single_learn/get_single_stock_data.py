...
if __name__ == '__main__':
    ...
    # downloader = Downloader('./stockdata/train', date_start='2010-01-01', date_end='2022-12-29')
    # downloader.run()

    mkdir('./stockdata/test')
    downloader = Downloader('./stockdata/test', date_start='2023-01-01', date_end='2024-12-31')
    downloader.run()
